...
# ex:ts=4
#
# $FreeBSD: head/Mk/bsd.port.mk 516983 2019-11-07 16:30:12Z rene $
#	$NetBSD: $
#
...
#				  ${LOCALBASE}/lib/ldconfig/${PKGBASE} which is then
...
# 				  ${LOCALBASE}/lib/ldconfig32/${PKGBASE} instead.
...
.if defined(INFO)
RUN_DEPENDS+=	indexinfo:system/indexinfo
...
#			${MV} ${STAGEDIR}${PREFIX}/lib/pkgconfig/* ${STAGEDIR}${PREFIX}/lib/pkgconfig; \
#		fi; \
