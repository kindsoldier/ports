--- ./mozilla/security/nss/lib/util/secasn1d.c.orig	2017-05-08 11:24:51.272918000 +0200
+++ ./mozilla/security/nss/lib/util/secasn1d.c	2017-05-08 11:26:11.340634000 +0200
@@ -1608,25 +1608,25 @@
 	}
         offset = item->len;
