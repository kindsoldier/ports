...
+++ ./src/network/ssl/qsslsocket_openssl_symbols.cpp	2019-12-24 00:25:52.046502000 +0200
@@ -110,17 +110,19 @@
...
+DEFINEFUNC(const int, BIO_free, BIO *a, a, return 0, return)
...
+#else
+DEFINEFUNC2(int, OPENSSL_init_ssl, uint64_t opts, opts, OPENSSL_INIT_SETTINGS *settings, settings, return -1, return)
+#endif
...
+#else
+DEFINEFUNC2(int, OPENSSL_init_crypto, uint64_t opts, opts, OPENSSL_INIT_SETTINGS *settings, settings, return -1, return)
+#endif
